...
if ($_POST){
    ...
    if(empty($member)){
        ...
        include "koneksi.php";
        $insert=mysqli_query($conn,"insert into transaksi (id_member,tanggal,tanggal_bayar,paket,berat_paket,total_harga,status,dibayar,id_user) value ('".$member."','".$tanggal."','".$tanggal_bayar."','".$harga."','".$berat."','".$total_harga."','".$status."','".$dibayar."','".$id_user."')");
        if ($insert){
